...
@section('content')
 ...
 <div class="card-body">
	...
	<input class="form-control" type="text" value="{{$admin->admin_nama}}" name="admin_nama" placeholder="Nama User">
	</div>
	<div class="form-group">
		<label>Status</label>
	<input class="form-control" type="text" value="{{$admin->admin_status}}" name="admin_status" placeholder="Nama User">
	</div>
	<div class="form-group">
