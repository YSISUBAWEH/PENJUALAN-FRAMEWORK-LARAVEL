  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ URL::asset('adminlte/dist/img/weh.png');}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
@yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022  <a href="">Weh</a>.</strong> All rights reserved.
  </footer>
